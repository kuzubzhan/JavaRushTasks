        ...
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (res == 0) {
                    ...
                    res = ((Integer) gc2.get(Calendar.YEAR)).compareTo(gc1.get(Calendar.YEAR));

                    if (res == 0) {
                        res = ((Integer) gc2.get(Calendar.MONTH)).compareTo(gc1.get(Calendar.MONTH));

                        if (res == 0) {
                            res = ((Integer) gc2.get(Calendar.DAY_OF_MONTH)).compareTo(gc1.get(Calendar.DAY_OF_MONTH));

                            if (res == 0) {
                                if (stock1.get("open") != null && stock1.get("last") != null &&
                                        stock2.get("open") != null && stock2.get("last") != null)
                                {
